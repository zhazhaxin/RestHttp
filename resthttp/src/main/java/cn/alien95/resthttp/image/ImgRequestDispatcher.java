...
public class ImgRequestDispatcher {
    ...
    public void addImgRequest(String url, ImageCallback callback) {
        loadImg(url, 1, callback);
    }

    public void addImgRequestWithCompress(String url, int inSimpleSize, ImageCallback callback) {
        loadImg(url, inSimpleSize, callback);
    }

    public void addImgRequestWithCompress(String url, int reqWidth, int reqHeight, ImageCallback callback) {
